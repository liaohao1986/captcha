...
public class ImagePreProcess2 {
    ...
    public static Map<BufferedImage, String> loadTrainData() throws Exception {
        if (trainMap == null) {
            ...
            File dir = new ClassPathResource("train2").getFile();
    ...
    public static String getAllOcr(String filename) throws Exception {
        ...
        for (int i = 0; i < listImg.size(); i++) {
            ...
            ImageIO.write(image, "JPG", new File("result\\batch_split2\\" + StringUtils.leftPad(file.getName().split("\\.")[0], 4, "0") + "_" + i + ".jpg"));
        }
        ImageIO.write(img, "JPG", new File("result\\result2\\" + StringUtils.leftPad(file.getName().split("\\.")[0], 4, "0") + "_" + result + ".jpg"));
        return result;
    }
