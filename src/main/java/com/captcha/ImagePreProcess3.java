...
public class ImagePreProcess3 {
    ...
    public static Map<BufferedImage, String> loadTrainData() throws Exception {
        if (trainMap == null) {
            ...
            File dir = new ClassPathResource("train3").getFile();
    ...
    public static String getAllOcr(String filename) throws Exception {
        ...
        for (int i = 0; i < listImg.size(); i++) {
            ...
            ImageIO.write(image, "JPG", new File("batch_split3\\" + StringUtils.leftPad(file.getName().split("\\.")[0], 4, "0") + "_" + i + ".jpg"));
        }
        ImageIO.write(img, "JPG", new File("result3\\" + StringUtils.leftPad(file.getName().split("\\.")[0], 4, "0") + "_" + result + ".jpg"));
        return result;
    }
        ...
        for (File file : files) {
            ...
            if (listImg.size() == 5) {
                for (int j = 0; j < listImg.size(); ++j) {
                    ImageIO.write(listImg.get(j), "JPG", new File("train3_2\\" + file.getName().charAt(j) + "-" + (index++) + ".jpg"));
                }
            }
        }
    }
